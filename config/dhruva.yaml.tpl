...
MachineAccountCredential: '{{ .Dhruva.config.MachineAccountCredential }}'
hostPortEnabled: '{{ .Dhruva.config.hostPortEnabled }}'
hostIpOrFqdn: '{{ .Dhruva.config.hostIpOrFqdn }}'
...
directMetricsToInfluxDBEnabled: '{{ .Dhruva.config.directMetricsToInfluxDBEnabled }}'
...
kafkaMetricsEnabled: '{{ .Dhruva.config.kafkaMetricsEnabled }}'
...
kafkaTopicMetricsDeliveryInfoCurrentDC: '{{ .Dhruva.config.kafkaTopicMetricsDeliveryInfoCurrentDC }}'
LOGBACK_HOSTNAME: '{{ .Dhruva.config.LOGBACK_HOSTNAME }}'
logback_include_caller_data: '{{ .Dhruva.config.logback_include_caller_data }}'
...
influxDBName: '{{ .Dhruva.config.influxDBName }}'
influxDBRetentionPolicy: '{{ .Dhruva.config.influxDBRetentionPolicy }}'
influxDBUrl: '{{ .Dhruva.config.influxDBUrl }}'
influxMaxConcurrentRequests: '{{ .Dhruva.config.influxMaxConcurrentRequests }}'
influxOperationTimeout: '{{ .Dhruva.config.influxOperationTimeout }}'
influxUseCircuitBreaker: '{{ .Dhruva.config.influxUseCircuitBreaker }}'
influxWriteOperationTimeout: '{{ .Dhruva.config.influxWriteOperationTimeout }}'
...
l2sipClusterAddress: '{{ .Dhruva.deploy.l2sipClusterAddress }}'
