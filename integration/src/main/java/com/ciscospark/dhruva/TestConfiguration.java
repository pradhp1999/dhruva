...
public class TestConfiguration extends BaseTestConfig {
  ...
  @Bean
  public DhruvaClientFactory helloWorldClientFactory(
      TestProperties testProperties, DhruvaTestProperties helloWorldTestProperties) {
    Preconditions.checkNotNull(testProperties);
    return DhruvaClientFactory.builder(testProperties, helloWorldTestProperties.helloWorldUrl())
        .build();
  }
}
