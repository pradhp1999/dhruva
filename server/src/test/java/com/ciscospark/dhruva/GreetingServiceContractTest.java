...
//
/// **
// * The purpose of this test is to show how to consume a stubbed version of the Feature Service
// using
// * the Spring Cloud Contract framework. Once the stubs are generated by the Producer, they are
// packaged
...
// * Dhruva Service (Consumer). These contracts specify what Feature Toggle is returned for
// Authorised
// * and Non Authorised users. On this example, the Dhruva Service looks for the feature key
// * “dhruva-adduserresponse”, which will be enabled for authorised users but disabled for not
// authorised.
// * <p>
// * Finally, note that in this tests real HTTP requests are being fired against a locally deployed
// version
// * of Feature Service - see localhost:8090. As could be seen down below, the tests use a real
// version of
...
// *   - if you are using a non default location for local repo (i.e. have set localRepository in
// maven settings.xml) then
// *      pass the property  -Dmaven.repo.local=/path/to/local/repo  to the jvm when running the
// tests
// *   - optionally: you can change the '+' to refer to a specific version, e.g.
// com.cisco.wx2:feature-server:1.0-SNAPSHOT:stubs:8090
// * */
//// @AutoConfigureStubRunner(workOffline = true, ids = "com.cisco.wx2:feature-server:+:stubs:8090")
// // Config for testing against stubs from local repository
// @AutoConfigureStubRunner(repositoryRoot =
// "http://engci-maven-master.cisco.com/artifactory/webex-cca-group", ids =
// "com.cisco.wx2:feature-server:+:stubs:8090")
...
//    static final String message = "To alcohol! The cause of, and solution to, all of life's
// problems.";
//    static final String trailer = " Proudly created by: ";
//    private static final String JOE_RANDOM_TEST_USER = "Joe Random TestUser";
//    private static final UUID JOE_RANDOM_TEST_UUID =
// UUID.fromString("b3474dff-8de5-4b12-8e2b-dfeee1cd11b2");
//
//    private static final String BOB_RANDOM_UNAUTHORIZED_USER = "BOB Random TestUser";
//    private static final UUID BOB_RANDOM_UNAUTHORIZED_TEST_UUID =
// UUID.fromString("2fdf0844-d1aa-4d4b-8699-8043b97ddac5");
//
//    @MockBean
...
//        Greeting expected = Greeting.builder().greeting("Doh! Homer
// Simpson").message(message).build();
//        assertThat(greetingService.getGreeting("Homer Simpson", Optional.empty()))
//                .isEqualTo(expected);
//    }
//
//    /**
//     * GET that is done by an authorised user, which makes the Feature Service to return an
// enabled Feature Toggle and
...
//
//        Greeting expected = Greeting.builder().greeting("Doh! Homer Simpson").message(message +
// trailer + JOE_RANDOM_TEST_USER).build();
//        assertThat(greetingService.getGreeting("Homer Simpson", Optional.of(authInfo)))
//                .isEqualTo(expected);
//    }
//
//    /**
//     * GET that is done by an non-authorised user, which makes the Feature Service to return an
// disabled Feature Toggle and
