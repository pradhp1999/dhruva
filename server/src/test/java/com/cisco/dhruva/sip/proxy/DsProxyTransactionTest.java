...
public class DsProxyTransactionTest {
    ...
    void init() throws Exception {
        ...
        //Add listen interfaces in DsControllerConfig, causes issues in getVia while sending out the packet
    ...
    public void testProxyClientTransaction() throws DsException, IOException {
        ...
        //when(transactionFactory.createClientTransaction(sipRequest, null, proxy.getTransactionInterfaces())).thenReturn(mockSipClientTransaction);
        doReturn(mockSipClientTransaction)
                .when(transactionFactory)
                .createClientTransaction(any(DsSipRequest.class),
        ...
        doReturn(mockSipClientTransaction).when(transactionManager).startClientTransaction(mockSipClientTransaction);
        //when(transactionManager.startClientTransaction(mockSipClientTransaction)).thenReturn(mockSipClientTransaction);

        doReturn(mockSipClientTransaction).when(transactionManager).startClientTransaction(
                any(DsSipRequest.class), any(DsSipClientTransportInfo.class),
                any(DsProxyTransaction.TransactionInterfaces.class));
        ...
        doNothing().when(appInterfaceMock).handleResponse(any(Location.class), any(Optional.class), any(int.class));
        ctrlr.proxyTo(loc, sipRequest, appInterfaceMock);

        Assert.assertNotNull(proxy.getClientTransaction());


        DsProxyTransaction.TransactionInterfaces  transactionInterfaces = proxy.getTransactionInterfaces();
    ...
    public void testProxyClientResponseWithRRHeader() throws DsException, IOException {
        ...
        DsSipRecordRouteHeader rrHeader = new DsSipRecordRouteHeader(
                "Record-Route: <sip:rr,n=Default@1.2.3.4:5060;transport=udp;lr>"
                        .getBytes());
    ...
    public void testProxyClientTransactionFinalResponses() throws DsException, IOException {
        ...
        DsSipResponse resp4xx =
                DsProxyResponseGenerator.createResponse(DsSipResponseCode.DS_RESPONSE_BAD_REQUEST, sipRequest);
        ...
        DsSipResponse resp5xx =
                DsProxyResponseGenerator.createResponse(DsSipResponseCode.DS_RESPONSE_BAD_GATEWAY, sipRequest);
        ...
        DsSipResponse resp3xx =
                DsProxyResponseGenerator.createResponse(DsSipResponseCode.DS_RESPONSE_MOVED_PERMANENTLY, sipRequest);
    ...
    public void testTransactionInterfacesServerICMPError() throws DsException, IOException {
        ...
        verify(appInterfaceMock, times(0)).handleResponse(any(Location.class), any(Optional.class), eq(4));
    ...
    public void testTransactionInterfacesServerCloseEvent() throws DsException, IOException {
        ...
        //In this case CANCEL is triggered from proxy/controller for server close, first call onNewRequest
    ...
    public void testTransactionInterfacesServerAckEvent() throws DsException, IOException {
        ...
        ArgumentCaptor<DsSipCancelMessage> argumentCaptor = ArgumentCaptor.forClass(DsSipCancelMessage.class);

        DsSipAckMessage ackRequest =
                (DsSipAckMessage) SIPRequestBuilder.createRequest(
