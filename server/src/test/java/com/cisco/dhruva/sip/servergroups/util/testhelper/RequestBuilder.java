...
public class RequestBuilder {
  ...
  public static DsSipRequest getFreshInvite() throws Exception {

    String sipMessage =
        "INVITE sip:userName@cisco.webex.com SIP/2.0\n"
            + "Via: SIP/2.0/TCP 192.168.65.141:7002;branch=z9hG4bK-4955-1-0\n"
            + "Max-Forwards: 69\n"
            + "To: sut <sip:73sVgblHnSQtmLz08VXs8dag@192.168.65.141:5060>\n"
            + "From: 123 <sip:123@192.168.65.141:7002>;tag=4955SIPpTag001\n"
            + "Contact: sip:123@192.168.65.141:7002;ifocus\n"
            + "ROUTE: <sip:iccmrfa1-ta.bts.prv.webex.com;transport=tcp;lr;profile=ecccp31990iccmr10990;shorturiDestination=ecp>\n"
            + "Call-ID: 1-4955@192.168.65.141\n"
            + "CSeq: 1 INVITE\n"
            + "Content-Length: 0\n"
            + "Subject: Performance Test\n"
