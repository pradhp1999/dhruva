...
/**
 * This class represents a Content-Language header as specified in RFC 3261. It provides methods to
 ...
 * </pre> </code>
 */
public final class DsSipContentLanguageHeader extends DsSipLanguageHeader {
  /** Header token. */
  public static final DsByteString sToken = BS_CONTENT_LANGUAGE;
  /** Header ID. */
  public static final byte sID = CONTENT_LANGUAGE;
  /** Compact header token. */
  public static final DsByteString sCompactToken = BS_CONTENT_LANGUAGE;

  /** Default constructor. */
  public DsSipContentLanguageHeader() {
    super();
  }
   ...
   */
  public DsSipContentLanguageHeader(byte[] value)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipContentLanguageHeader(byte[] value, int offset, int count)
      throws DsSipParserException, DsSipParserListenerException {
    /*
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipContentLanguageHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
  ...
  public final DsByteString getTokenC() {
    return BS_CONTENT_LANGUAGE_TOKEN;
  }
...
} // Ends class DsSipContentLanguageHeader
