...
/**
 * This class defines the exception arising in the parsing process.  It has been extended to
 * contain more information about what type of parsing error has occurred.
 */
public class DsSipParserException extends DsException
{
    ...
    /**
     * Constructor which accepts an exception, plus additional information for
     * recovery from the exception.  This Exceptions message and stack trace
     * will be useded.
     *
    ...
    /**
     * Constructor which accepts the exception message, plus additional information for
    ...
    /**
     * Set the header list, the value of each header is just the data string that failed
     * parsing.  The header is marked as invalid.
     *
