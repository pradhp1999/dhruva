...
public class ResponseReasonCodeConstants {
    ...
    public static final HashMap INT_TO_STR_MAP = new HashMap(23);

    static {
      INT_TO_STR_MAP.put(new Integer(UNREACHABLE), UNREACHABLE_STR);
      INT_TO_STR_MAP.put(new Integer(ICMP),  ICMP_STR);
      INT_TO_STR_MAP.put(new Integer(TIMEOUT), TIMEOUT_STR);
      INT_TO_STR_MAP.put(new Integer(DOWN), DOWN_STR);
      INT_TO_STR_MAP.put(new Integer(UNKNOWN_SG), UNKNOWN_SG_STR);
      INT_TO_STR_MAP.put(new Integer(EMPTY), EMPTY_STR);
      INT_TO_STR_MAP.put(new Integer(SUCCESS), SUCCESS_STR);
      INT_TO_STR_MAP.put(new Integer(REDIRECT), REDIRECT_STR);
      INT_TO_STR_MAP.put(new Integer(PROXY_ERROR), PROXY_ERROR_STR);
      INT_TO_STR_MAP.put(new Integer(NO_LOCATIONS), NO_LOCATIONS_STR);
      INT_TO_STR_MAP.put(new Integer(CANCELLED), CANCELLED_STR);
      INT_TO_STR_MAP.put(new Integer(UNDEFINED), UNDEFINED_STR);
      INT_TO_STR_MAP.put(new Integer(SERVER_GROUP_TIMEOUT), TIMEOUT_STR);
    }
  ...
  public static final DsByteString getReasonStrFromInt(int reasonCode)
  {
    return (DsByteString)INT_TO_STR_MAP.get(new Integer(reasonCode));
  }
}
