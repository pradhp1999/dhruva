...
public enum DsProxyErrorCode {
  ...
  ERROR_TLS_HANDSHAKE_MISC1(
      714, "TLS Hankshake Failed, Remote Host Closed Connection During Handshake"),
  ERROR_TLS_HANDSHAKE_CERT_EXT_EE(
      715, "TLS Hankshake Failed, End Entity Certificate Extension Check Failed"),
  ERROR_TLS_HANDSHAKE_CERT_EXT_CA(
      716, "TLS Hankshake Failed, CA Certificate Extension Check Failed"),
  ERROR_TLS_HANDSHAKE_CERT_SIGN(
      717, "TLS Hankshake Failed, Certificate Signature Validation Failed"),
  ERROR_TLS_HANDSHAKE_CERT_CHAIN(718, "TLS Hankshake Failed, Certificate Chaining Error"),
  ERROR_TLS_HANDSHAKE_CERT_SIGN_ALG(
      719, "TLS Hankshake Failed, Certificate Signature Algorithm Disabled"),
