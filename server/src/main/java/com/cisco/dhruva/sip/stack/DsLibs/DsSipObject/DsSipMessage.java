...
public abstract class DsSipMessage extends DsSipMessageBase {
  ...
  /*Signifies if message is  generated by Dhruva or not, default set to true
  If the message is received from transport , we will set it to false
  in DsSipTransactionManager afetr parsing*/
  private boolean isInternallyGenerated = true;
