...
/**
 * Provides Read-Only access to a Route header.
 *
 * <p>
 *
 * <blockquote>
 ...
 * </blockquote>
 */
public class DsSipRouteElements implements DsSipElementListener {
  ...
  /** Index of the Method Paramter, add 1 for length. */
  ...
  DsSipRouteElements(int base, byte[] index) {
    this.idx = index;
    this.base = base;
