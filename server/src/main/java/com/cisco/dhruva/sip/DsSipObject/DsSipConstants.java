...
public interface DsSipConstants
{
    ...
    /** The constant ID used in parser events as context ID for any URL other
     *  than SIP, TEL or CID URLs.
     */
    ...
    public static final DsByteString BS_P_ACCESS_NETWORK_INFO = new DsByteString("P-Access-Network-Info");
    ...
    public static final DsByteString BS_P_CHARGING_FUNCTION_ADDRESSES = new DsByteString("P-Charging-Function-Addresses");
    ...
    public static final DsByteString BS_P_VISITED_NETWORK_ID = new DsByteString("P-Visited-Network-ID");
    /** The byte string constant for P-Preferred-Identity header name. */
    public static final DsByteString BS_P_PREFERRED_IDENTITY = new DsByteString("P-Preferred-Identity");
    ...
    public static final DsByteString BS_SERVICE_AGENT_APPLICATION = new DsByteString("SE-Application");
    /** The byte string constant for Service-Agent-Application header name. */
    ...
    public static final DsByteString BS_SUBSCRIPTION_EXPIRES = new DsByteString("Subscription-Expires");
    ...
    public static final DsByteString BS_CONTENT_TRANSFER_ENCODING = new DsByteString("Content-Transfer-Encoding");
    ...
    public static final DsByteString BS_CISCO_MAINTENANCE_MODE = new DsByteString("Cisco-Maintenance-Mode");
    ...
    public static final DsByteString BS_X_APPLICATION_CONTEXT = new DsByteString("X-Application-Context");
...
//per Edgar, no longer used by AE
    ...
    public static final DsByteString X_CISCO_PEER_CERT_INFO_STRING = new DsByteString("X-Cisco-Peer-Cert-Info");
    ...
    public static final DsByteString BS_AUTHENTICATION_INFO_TOKEN = new DsByteString("Authentication-Info: ");
    ...
    public static final DsByteString BS_CONTENT_DISPOSITION_TOKEN = new DsByteString("Content-Disposition: ");
    /** The byte string constant for "Content-Encoding: " token. */
    public static final DsByteString BS_CONTENT_ENCODING_TOKEN = new DsByteString("Content-Encoding: ");
    /** The byte string constant for "Content-Language: " token. */
    public static final DsByteString BS_CONTENT_LANGUAGE_TOKEN = new DsByteString("Content-Language: ");
    ...
    public static final DsByteString BS_P_ACCESS_NETWORK_INFO_TOKEN = new DsByteString("P-Access-Network-Info: ");
    /** The byte string constant for "P-Asserted-Identity: " token. */
    public static final DsByteString BS_P_ASSERTED_IDENTITY_TOKEN = new DsByteString("P-Asserted-Identity: ");
    /** The byte string constant for P-Associated-URI token. */
    public static final DsByteString BS_P_ASSOCIATED_URI_TOKEN = new DsByteString("P-Associated-URI: ");
    /** The byte string constant for "P-Called-Party-ID: " token. */
    public static final DsByteString BS_P_CALLED_PARTY_ID_TOKEN = new DsByteString("P-Called-Party-ID: ");
    ...
    public static final DsByteString BS_P_CHARGING_FUNCTION_ADDRESSES_TOKEN = new DsByteString("P-Charging-Function-Addresses: ");
    /** The byte string constant for "P-Charging-Vector: " token. */
    public static final DsByteString BS_P_CHARGING_VECTOR_TOKEN = new DsByteString("P-Charging-Vector: ");
    /** The byte string constant for "P-Visited-Network-ID: " token. */
    public static final DsByteString BS_P_VISITED_NETWORK_ID_TOKEN = new DsByteString("P-Visited-Network-ID: ");
    /** The byte string constant for "P-Preferred-Identity: " token. */
    public static final DsByteString BS_P_PREFERRED_IDENTITY_TOKEN = new DsByteString("P-Preferred-Identity: ");
    ...
    public static final DsByteString BS_PROXY_AUTHENTICATE_TOKEN = new DsByteString("Proxy-Authenticate: ");
    /** The byte string constant for "Proxy-Authorization: " token. */
    public static final DsByteString BS_PROXY_AUTHORIZATION_TOKEN = new DsByteString("Proxy-Authorization: ");
    ...
    public static final DsByteString BS_REQUEST_DISPOSITION_TOKEN = new DsByteString("Request-Disposition: ");
    ...
    public static final DsByteString BS_SERVICE_AGENT_APPLICATION_TOKEN = new DsByteString("SE-Application: ");
    /** The byte string constant for "SE-Context: " token. */
    public static final DsByteString BS_SERVICE_AGENT_CONTEXT_TOKEN = new DsByteString("SE-Context: ");
    ...
    public static final DsByteString BS_SUBSCRIPTION_EXPIRES_TOKEN = new DsByteString("Subscription-Expires: ");
    /** The byte string constant for "Subscription-State: " token. */
    public static final DsByteString BS_SUBSCRIPTION_STATE_TOKEN = new DsByteString("Subscription-State: ");
    ...
    public static final DsByteString BS_WWW_AUTHENTICATE_TOKEN = new DsByteString("WWW-Authenticate: ");
    ...
    public static final DsByteString BS_X_APPLICATION_CONTEXT_TOKEN = new DsByteString("X-Application-Context: ");
...
//per Edgar, no longer used by AE
    ...
    public static final DsByteString BS_X_CONNECTION_INFO_TOKEN = new DsByteString("X-Connection-Info: ");
    ...
    public static final DsByteString BS_SUPPRESS_IF_MATCH_TOKEN = new DsByteString("Suppress-If-Match: ");
    ...
    /** The byte string constant for Content-Description: header name. */
    public static final DsByteString BS_CONTENT_DESCRIPTION_TOKEN = new DsByteString("Content-Description: ");
    /** The byte string constant for "Content-Transfer-Encoding: " token. */
    public static final DsByteString BS_CONTENT_TRANSFER_ENCODING_TOKEN = new DsByteString("Content-Transfer-Encoding: ");

    // CAFFEINE 2.0 DEVELOPMENT - Cisco-Maintenance-Mode header support
    /** The byte string constant for "Cisco-Maintenance-Mode: " header name. */
    public static final DsByteString BS_CISCO_MAINTENANCE_MODE_TOKEN = new DsByteString("Cisco-Maintenance-Mode: ");
    ...
    public static final DsByteString BSU_DISP_EXTENSION_TOKEN = new DsByteString("DISP_EXTENSION_TOKEN");
    ...
    public static final DsByteString BS_ZERO_CONTENT_LENGTH_EOH = new DsByteString("Content-Length: 0\r\n");
    ...
    // MMA - 08.05.2005 - adding additional parameter names/tokens in support of the Reason header (RFC 3326)
    ...
    public static final DsByteString BS_ALMOST_OUT_OF_RESOURCE = new DsByteString("almost-out-of-resource");
     ...
     * @deprecated use {@link #clientTn} for Client Transaction or use
     *             {@link #serverTn} for Server Transaction.
     */
    ...
    /**
     * The Magic Cookie string that may be present in the branch parameter of
     * VIA header in the SIP message.
     */
    public final static DsByteString BS_MAGIC_COOKIE = new DsByteString("z9hG4bK");

    /** The number of characters in the Magic Cookie. */
    public final static int MAGIC_COOKIE_COUNT = 7;
