...
/**
 * This class represents the class for Reject-Contact header as specified in caller prefs.
 *
 * <p>It provides methods to build, access, modify, serialize and clone the header.
 *
 * <p><b>Header ABNF:</b> <code> <pre>
 * Reject-Contact  =  ("Reject-Contact" / "j") HCOLON acrc-value
 *                    *(COMMA rc-value)
 ...
 * </pre> </code>
 */
public final class DsSipRejectContactHeader extends DsSipAcceptRejectContactHeader {
  /** Header token. */
  public static DsByteString sToken = BS_REJECT_CONTACT;
  /** Header token plus colon. */
  public static DsByteString sTokenC = BS_REJECT_CONTACT_TOKEN;
  /** Header ID. */
  public static int sID = REJECT_CONTACT;

  /** Default constructor. */
  protected DsSipRejectContactHeader() {
    super();
  }
   ...
   *     of this header.
   */
  public DsSipRejectContactHeader(byte[] value)
   ...
   *     value part.
   */
  public DsSipRejectContactHeader(byte[] value, int offset, int count)
      throws DsSipParserException, DsSipParserListenerException {
    /*
   ...
   *     of this header.
   */
  public DsSipRejectContactHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
  ...
  public DsByteString getTokenC() {
    return (isCompact()) ? BS_REJECT_CONTACT_C_TOKEN : BS_REJECT_CONTACT_TOKEN;
  }
