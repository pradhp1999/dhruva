...
/**
 * Encapsulates parameters that can be passed to ProxyTransaction API
 * calls (i.e., only proxyTo() roght now) to modify the default behavior
 * for a single branch
 * NOTE: The API for this class might change as OAM&P matures
 */
