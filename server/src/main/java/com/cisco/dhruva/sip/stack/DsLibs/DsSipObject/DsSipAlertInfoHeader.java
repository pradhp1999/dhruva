...
/**
 * This class represents the Alert-Info header as specified in RFC 3261. It provides methods to
 * build, access, modify, serialize and clone the header.
 *
 * <p><b>Header ABNF:</b> <code> <pre>
 * Alert-Info =  "Alert-Info" ":" # ( "&LT" URI "&GT" *(";" generic-param ))
 * </pre> </code>
 */
public final class DsSipAlertInfoHeader extends DsSipUrlHeader {
  /** Header token. */
  public static final DsByteString sToken = BS_ALERT_INFO;
  /** Header ID. */
  public static final byte sID = ALERT_INFO;
  /** Compact header token. */
  public static final DsByteString sCompactToken = sToken;

  /** Default constructor. */
  public DsSipAlertInfoHeader() {
    super();
  }
   ...
   */
  public DsSipAlertInfoHeader(byte[] value)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipAlertInfoHeader(byte[] value, int offset, int count)
      throws DsSipParserException, DsSipParserListenerException {
    /*
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipAlertInfoHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
   ...
   */
  public DsSipAlertInfoHeader(DsURI uri) {
    super(uri);
  }
...
} // Ends class DsSipAlertInfoHeader
