...
/** This interface is used to control a proxy. The proxy
 * will invoke the various public methods of the controller
 * at opportune times. */
...
//    * the received request
  ...
  public DsProxyStatelessTransaction
	onNewRequest(DsSipServerTransaction server,
...
//   * responses.
  ...
  public void onBestResponse(DsProxyTransaction proxy,
          /*DsProxyServerTransaction trans,*/
                             DsSipResponse response);
