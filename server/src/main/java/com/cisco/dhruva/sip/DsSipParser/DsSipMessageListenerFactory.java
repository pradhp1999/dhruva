...
public interface DsSipMessageListenerFactory
{
     ...
     */
    DsSipMessageListener requestBegin(byte[] buffer, int methodOffset,
                                      int methodCount, boolean isEncoded) throws DsSipParserListenerException;
     ...
     * @throws DsSipParserListenerException if the listener decides there is a problem
     */
    DsSipMessageListener responseBegin(byte[] buffer, int code, int reasonOffset,
                                       int reasonCount, boolean isEncoded) throws DsSipParserListenerException;
}
