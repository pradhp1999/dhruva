...
public interface DsLoopCheckInterface {
  ...
  /**
   * Checks if the request is looped, normally by examining the list of
   * Via headers and request URI but other algorithms may also be implemented
   ...
   * @param n_branch an integer representing the branch of this request
   * (starts with 1 and gets incremented every time we fork)
