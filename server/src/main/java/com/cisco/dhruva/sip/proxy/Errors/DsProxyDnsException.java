...
public class DsProxyDnsException extends DsProxyError {
    ...
    public DsProxyDnsException(int queryType, String query, Exception e, DsBindingInfo bindingInfo) {
        ...
        if(e instanceof NameNotFoundException) {
            errorCode = (queryType == QUERY_TYPE_SRV) ? DsProxyErrorCode.ERROR_DNS_SRV_NO_RECORDS : DsProxyErrorCode.ERROR_DNS_A_NO_RECORDS;
        } else if(e instanceof CommunicationException) {
            errorCode = (queryType == QUERY_TYPE_SRV) ? DsProxyErrorCode.ERROR_DNS_SRV_QUERY_TIMEDOUT : DsProxyErrorCode.ERROR_DNS_A_QUERY_TIMEDOUT;
        } else {
            errorCode = (queryType == QUERY_TYPE_SRV) ? DsProxyErrorCode.ERROR_DNS_SRV_OTHER : DsProxyErrorCode.ERROR_DNS_A_OTHER;
        }
    }
