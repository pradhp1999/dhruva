...
public class DsProxyTlsConnectException extends DsProxyError {
    ...
    public DsProxyTlsConnectException(Exception e, DsSSLContext context, InetAddress localAddr, int localPort,
            InetAddress remortAddr, int remortPort) {
        this.context = context;
        this.exception = e;
        this.bindingInfo = new DsBindingInfo(localAddr, localPort, remortAddr, remortPort, DsSipTransportType.TLS);
    ...
    private void interpretPlatformException() {
        ...
        } else if (this.exception.getLocalizedMessage().contains("End entity certificate extension check failed")) {
            errorCode = DsProxyErrorCode.ERROR_TLS_HANDSHAKE_CERT_EXT_EE;
        } else if (this.exception.getLocalizedMessage().contains("CA certificate extension check failed")) {
        ...
        } else if (this.exception.getLocalizedMessage().contains("Certificate signature validation failed")) {
        ...
        } else if (this.exception.getLocalizedMessage().contains("Certificate signature algorithm disabled")) {
        ...
        } else if (this.exception.getLocalizedMessage().contains("Remote host closed connection during handshake")) {
    ...
    public String getDescription() {
        ...
        builder.append("{errorCode:").append(errorCode)
            .append(",exceptionClass:").append(exception.getClass())
            .append(",exceptionMessage:").append(exception.getLocalizedMessage());
            if(bindingInfo != null ) {
