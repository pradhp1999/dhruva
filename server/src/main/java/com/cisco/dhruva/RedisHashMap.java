...
/**
 * A simple wrapper around RedisCache to make it function as a standard java collections Map,
 * enabling us to abstract redis out of our tests. It also use a RedisCommonCommands to validate the
 * caching data for demonstration purpose.
 */
