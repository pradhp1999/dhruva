...
/**
 * This class represents the Remote-Party-ID header. It provides methods to build, access, modify,
 * serialize and clone the header.
 *
 * <p><b>Header ABNF:</b> <code> <pre>
 * Remote-Party-ID =  "Remote-Party-ID" ":" [display-name]
 *                      "<" addr-spec ">" *(";" rpi-token)
 * rpi-token       =  rpi-screen | rpi-pty-type |  rpi-id-type
 *                      | rpi-privacy | other-rpi-token
 ...
 * </pre> </code>
 */
public final class DsSipRemotePartyIdHeader extends DsSipNameAddressHeader {
  /** Header token. */
  public static final DsByteString sToken = BS_REMOTE_PARTY_ID;
  /** Header ID. */
  public static final byte sID = REMOTE_PARTY_ID;
  /** Compact header token. */
  public static final DsByteString sCompactToken = BS_REMOTE_PARTY_ID;

  /** Default constructor. */
  public DsSipRemotePartyIdHeader() {
    super();
  }
   ...
   */
  public DsSipRemotePartyIdHeader(byte[] value)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipRemotePartyIdHeader(byte[] value, int offset, int count)
      throws DsSipParserException, DsSipParserListenerException {
    /*
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipRemotePartyIdHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
   ...
   * @throws DsException if there is an error while parsing the nameAddress value
   */
  public DsSipRemotePartyIdHeader(DsByteString nameAddress, DsParameters parameters)
      throws DsException {
   ...
   * @param parameters the list of parameters for this header.
   */
  public DsSipRemotePartyIdHeader(DsSipNameAddress nameAddress, DsParameters parameters) {
    super(nameAddress, parameters);
  }
   ...
   * @param nameAddress the name address for this header.
   */
  public DsSipRemotePartyIdHeader(DsSipNameAddress nameAddress) {
   ...
   * @param parameters the list of parameters for this header.
   */
  public DsSipRemotePartyIdHeader(DsURI uri, DsParameters parameters) {
   ...
   * @param uri the uri for this header.
   */
  public DsSipRemotePartyIdHeader(DsURI uri) {
    super(uri);
  }
  ...
  public final DsByteString getTokenC() {
    return BS_REMOTE_PARTY_ID_TOKEN;
  }
  ...
  //        {
  //            byte[] bytes = read();
  //            DsSipRemotePartyIdHeader header = new DsSipRemotePartyIdHeader(bytes);
  // System.out.println();
  ...
  // System.out.println();
  //                    DsSipRemotePartyIdHeader clone = (DsSipRemotePartyIdHeader) header.clone();
