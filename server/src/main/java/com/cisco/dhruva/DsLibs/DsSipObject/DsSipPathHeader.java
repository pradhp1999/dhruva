...
/**
 * This class represents the Path header as specified in RFC 3327. It provides methods to build,
 * access, modify, serialize and clone the header.
 *
 * <p><b>Header ABNF:</b> <code> <pre>
 * Path         =  "Path" ":" path-value *( COMMA path-value )
 ...
 * </pre> </code>
 */
public final class DsSipPathHeader extends DsSipNameAddressHeader {
  /** Header token. */
  public static final DsByteString sToken = BS_PATH;
  /** Header ID. */
  public static final byte sID = PATH;
  /** Compact header token. */
  public static final DsByteString sCompactToken = sToken;

  /** Default constructor. */
  public DsSipPathHeader() {
    super();
  }
   ...
   */
  public DsSipPathHeader(byte[] value) throws DsSipParserException, DsSipParserListenerException {
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipPathHeader(byte[] value, int offset, int count)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipPathHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
   ...
   */
  public DsSipPathHeader(DsByteString nameAddress, DsParameters parameters)
   ...
   * @param parameters the list of parameters for this header.
   */
  public DsSipPathHeader(DsSipNameAddress nameAddress, DsParameters parameters) {
    super(nameAddress, parameters);
  }
   ...
   * @param nameAddress the name address for this header.
   */
  public DsSipPathHeader(DsSipNameAddress nameAddress) {
   ...
   * @param parameters the list of parameters for this header.
   */
  public DsSipPathHeader(DsURI uri, DsParameters parameters) {
   ...
   * @param uri the uri for this header.
   */
  public DsSipPathHeader(DsURI uri) {
    super(uri);
  }
  ...
  //            byte[] bytes = read();
  //            byte[] bytes = "c1
  // <sip:63.113.46.75:5060;transport=UDP>;methods=\"MESSAGE,NOTIFY,SUBSCRIBE\"".getBytes();
  //            DsSipPathHeader header = new DsSipPathHeader(bytes);
  //            System.out.println();
