...
/**
 * This class represents the Allow-Events header as specified in RFC 3265. It provides methods to
 ...
 * </pre> </code>
 */
public final class DsSipAllowEventsHeader extends DsSipEventHeaderBase {
  /** Header token. */
  public static final DsByteString sToken = BS_ALLOW_EVENTS;
  /** Header ID. */
  public static final byte sID = ALLOW;
  /** Compact header token. */
  public static final DsByteString sCompactToken = BS_ALLOW_EVENTS_C;

  /** Default constructor. */
  public DsSipAllowEventsHeader() {
    super();
  }
   ...
   */
  public DsSipAllowEventsHeader(byte[] value)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipAllowEventsHeader(byte[] value, int offset, int count)
      throws DsSipParserException, DsSipParserListenerException {
    /*
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipAllowEventsHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
   ...
   */
  public DsSipAllowEventsHeader(DsByteString eventPackage, DsByteString subPackage) {
  ...
  public final DsByteString getTokenC() {
    return (isCompact()) ? BS_ALLOW_EVENTS_C_TOKEN : BS_ALLOW_EVENTS_TOKEN;
  }
