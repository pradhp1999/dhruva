...
/**
 * This class represents the P-Asserted-Identity header as specified in RFC 3325. It provides
 * methods to build, access, modify, serialize and clone the header.
 *
 * <p><b>Header ABNF:</b> <code> <pre>
 * P-Asserted-Identity =  "P-Asserted-Identity" HCOLON PAssertedID-value
 *                          *(COMMA PAssertedID-value)
 * PAssertedID-value = name-addr / addr-spec
 * </pre> </code>
 */
public final class DsSipPAssertedIdentityHeader extends DsSipNameAddressHeader {
  /** Header token. */
  public static final DsByteString sToken = BS_P_ASSERTED_IDENTITY;
  /** Header ID. */
  public static final byte sID = P_ASSERTED_IDENTITY;
  /** Compact header token. */
  public static final DsByteString sCompactToken = sToken;

  /** Default constructor. */
  public DsSipPAssertedIdentityHeader() {
    super();
  }
   ...
   */
  public DsSipPAssertedIdentityHeader(byte[] value)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipPAssertedIdentityHeader(byte[] value, int offset, int count)
      throws DsSipParserException, DsSipParserListenerException {
    /*
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipPAssertedIdentityHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
   ...
   */
  public DsSipPAssertedIdentityHeader(DsByteString nameAddress, DsParameters parameters)
   ...
   * @param parameters the list of parameters for this header.
   */
  public DsSipPAssertedIdentityHeader(DsSipNameAddress nameAddress, DsParameters parameters) {
    super(nameAddress, parameters);
  }
   ...
   * @param nameAddress the name address for this header.
   */
  public DsSipPAssertedIdentityHeader(DsSipNameAddress nameAddress) {
   ...
   * @param parameters the list of parameters for this header.
   */
  public DsSipPAssertedIdentityHeader(DsURI uri, DsParameters parameters) {
   ...
   * @param uri the uri for this header.
   */
  public DsSipPAssertedIdentityHeader(DsURI uri) {
    super(uri);
  }
  ...
  public final DsByteString getTokenC() {
    return BS_P_ASSERTED_IDENTITY_TOKEN;
  }
    ...
    try {
      ...
      byte[] bytes =
          "c1 <sip:63.113.46.75:5060;transport=UDP>;methods=\"MESSAGE,NOTIFY,SUBSCRIBE\""
              .getBytes();
      DsSipPAssertedIdentityHeader header = new DsSipPAssertedIdentityHeader(bytes);
      System.out.println();
      ...
      System.out.println();
      DsSipPAssertedIdentityHeader clone = (DsSipPAssertedIdentityHeader) header.clone();
