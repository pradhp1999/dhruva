...
/**
 * This class represents the Server header as specified in RFC 3261. It provides methods to build,
 ...
 * </pre> </code>
 */
public final class DsSipServerHeader extends DsSipServerBase {
  /** Header token. */
  public static final DsByteString sToken = BS_SERVER;
  /** Header ID. */
  public static final byte sID = SERVER;
  /** Compact header token. */
  public static final DsByteString sCompactToken = sToken;

  /** Default constructor. */
  public DsSipServerHeader() {
    super();
  }
   ...
   */
  public DsSipServerHeader(byte[] value) throws DsSipParserException, DsSipParserListenerException {
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipServerHeader(byte[] value, int offset, int count)
   ...
   *     a Parser Listener, while parsing.
   */
  public DsSipServerHeader(DsByteString value)
      throws DsSipParserException, DsSipParserListenerException {
